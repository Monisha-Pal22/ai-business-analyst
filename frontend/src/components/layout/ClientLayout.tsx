    ...
    <div className="min-h-screen bg-slate-100">
      ...
      {!chatOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center shadow-xl hover:bg-blue-700 transition-all z-50 hover:scale-110 group"
        ...
        >
          ...
          {/* Pulse ring */}
          <span className="absolute inset-0 rounded-full bg-blue-400 opacity-0 group-hover:opacity-30 scale-110 transition-all" />
        </button>
      )}
      ...
      {chatOpen && (
        <div
          ...
          style={{ width: "390px", height: "590px" }}
        >
          <ChatWidget isPopup={true} onClose={() => setChatOpen(false)} />
        </div>
      )}
